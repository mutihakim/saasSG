...
import { FinancePocket } from "../../Finance/types";
import { WalletWish } from "../types";
...
type Props = {
    ...
    onApproveReject: (wish: WalletWish, action: "approve" | "reject") => void;
    onConvert: (wish: WalletWish) => void;
    onEdit: (wish: WalletWish) => void;
    onDelete: (wish: WalletWish) => void;
};

const WalletWishesTab = ({ wishes, canCreateGoal, onApproveReject, onConvert, onEdit, onDelete }: Props) => {
...
export default WalletWishesTab;
