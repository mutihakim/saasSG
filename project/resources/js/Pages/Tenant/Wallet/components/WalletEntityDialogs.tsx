...
type Props = {
    ...
    setSelectedWallet: (wallet: FinancePocket | null) => void;
    setWalletForm: (form: WalletFormState) => void;
    handleDeleteWallet: (wallet: FinancePocket) => void;
    ...
    handleSaveWallet: (values: WalletFormState) => Promise<void>;
...
export default WalletEntityDialogs;
