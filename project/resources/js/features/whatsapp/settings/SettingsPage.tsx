...
const RemoveSessionConfirmModal = lazy(() => import("./components/RemoveSessionConfirmModal"));
...
function WhatsAppSettingsPage() {
    ...
    const normalizeSessionForDisplay = useCallback((payload: SessionPayload): SessionPayload => {
