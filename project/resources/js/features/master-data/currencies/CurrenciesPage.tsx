...
import { Currency, MasterDataPermissions } from "@/features/master-data/types";
...
const CurrenciesIndex = ({ currencies: initialCurrencies, permissions }: CurrenciesProps) => {
  ...
  const { refreshCurrencies, removeCurrency } = useMasterData();
  ...
  const fetchCurrencies = async () => {
    try {
      const nextCurrencies = await refreshCurrencies();
