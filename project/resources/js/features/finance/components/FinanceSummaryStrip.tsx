...
import { FinanceFilterDraft, FinanceWallet } from "../types";
...
type FinanceWalletFilterOption = {
    value: string;
    label: string;
...
type Props = {
    ...
    filters: Pick<FinanceFilterDraft, "type" | "owner_member_id" | "bank_account_id" | "wallet_id">;
...
const FinanceSummaryStrip = ({
    ...
    const walletOptions = React.useMemo<FinanceWalletFilterOption[]>(() => {
        const options: FinanceWalletFilterOption[] = [{
            value: "",
            label: "ALL MEMBERS",
            kind: "all",
            ownerMemberId: "",
    ...
    const selectedWalletOption = React.useMemo(
        () => {
            if (filters.wallet_id) {
                return walletOptions.find((option) => option.kind === "wallet" && option.pocketId === String(filters.wallet_id)) ?? null;
            }
        ...
        [filters.bank_account_id, filters.owner_member_id, filters.wallet_id, walletOptions],
    );
                ...
                <div className="d-flex flex-column gap-2">
                    ...
                    <div className="d-grid" style={{ gap: 12, gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
                        ...
                        <div>
                            ...
                            <Select<FinanceWalletFilterOption, false>
