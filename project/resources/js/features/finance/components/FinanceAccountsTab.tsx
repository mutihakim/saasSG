...
import { FinanceAccount, FinanceWallet } from "../types";
import { FinanceGroupedAccountPockets, FinancePermissions } from "../types";

import { formatCurrency } from "./pwa/types";

type Props = {
    groupedWallets: FinanceGroupedAccountPockets[];
    ...
    onOpenWalletDetail: (wallet: FinanceWallet) => void;
...
const getWalletRibbon = (wallet: FinanceWallet) => {
...
const getPurposeBadge = (purposeType?: FinanceWallet["purpose_type"]) => {
    switch (purposeType) {
        case "income":
