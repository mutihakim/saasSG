        ...
        >
            <div className="game-setup-card h-100">
                <div className="game-setup-content game-setup-inner-content">
                    {/* Mode Selector Tabs */}
                            <div className="tahfiz-history__tab-container game-mode-container mb-4">
                                <button 
                                    type="button" 
                                    className={`game-mode-btn ${activeTab === "reading" ? "active" : ""}`} 
                                ...
                                <button 
                                    type="button" 
                                    className={`game-mode-btn ${activeTab === "murojaah" ? "active" : ""}`} 
                                    onClick={() => setActiveTab("murojaah")}
                                >
                                    {t("tenant.games.tahfiz.history.tab_murojaah")}
                                </button>
                                <div className={`game-mode-slider ${activeTab === "murojaah" ? "is-mencariB" : "is-mencariC"} has-two-options`} />
                            </div>
