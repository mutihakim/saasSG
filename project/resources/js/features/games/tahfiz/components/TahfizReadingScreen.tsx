...
const TahfizReadingScreen: React.FC<Props> = ({
    ...
    return (
        <div className="tahfiz-reading">
            ...
            <div className="tahfiz-reading__content-wrapper px-3">
                <div className="tahfiz-reading__tabs-area">
                ...
                <main className="tahfiz-reading__main">
                    <div className="tahfiz-reading__card">
                        <button
                            type="button"
                        ...
                        >
                            <i className={`${isFavorite ? 'ri-star-fill' : 'ri-star-line'} fs-5`} />
                            {isFavorite && (favoriteData?.note || favoriteData?.category) && <span className="fav-dot"></span>}
                        </button>

                        <span className="tahfiz-reading__ayah-info">
                            {t("tenant.games.tahfiz.reading.ayah_info", { current: currentAyah.nomor_ayat, total: surah.jumlah_ayat })}
                        </span>

                        <div className="tahfiz-reading__display px-2">
                            {activeTab === 'arab' && (
                                <p className="tahfiz-reading__text-arabic" dir="rtl">
                                    {currentAyah.teks_arab}
                                </p>
                            )}
                            {activeTab === 'latin' && (
                                <p className="tahfiz-reading__text-latin">
                                    {currentAyah.teks_latin}
                                </p>
                            )}
                            {activeTab === 'terjemah' && (
                                <p className="tahfiz-reading__text-translation">
                ...
                <div className="tahfiz-reading__controls-area">
                    <div className="tahfiz-reading__controls-inner">
                        <div className="tahfiz-reading__timeline">
                        ...
                        <div className="tahfiz-reading__buttons">
