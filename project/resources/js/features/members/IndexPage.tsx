...
import React, { FormEvent, Suspense, lazy, useMemo, useState } from "react";
import { Button, Card, Col, Dropdown, Form, Offcanvas, Row } from "react-bootstrap";
...
const QuickAddMemberModal = lazy(() => import("./components/QuickAddMemberModal"));
const InviteMemberModal = lazy(() => import("./components/InviteMemberModal"));
            ...
            {showQuickAdd ? (
                <Suspense fallback={null}>
                    <QuickAddMemberModal
                        ...
                        loading={loading}
                        form={quickForm}
                        roleOptions={quickAddRoleOptions}
                        roleLabel={roleLabel}
