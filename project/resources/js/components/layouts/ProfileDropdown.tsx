...
export default function ProfileDropdown() {
    ...
    const workspaceLink = useMemo(() => {
        ...
        return tenantSlug ? '/admin/dashboard' : '/tenant-access-required';
        ...
        >
            ...
            <Dropdown.Menu className="dropdown-menu-end">
                ...
                <Dropdown.Item href={route('profile.edit')} className="dropdown-item">
                    <i className="ri-user-3-line text-muted fs-16 align-middle me-1"></i>
                ...
                <Dropdown.Item href={route('profile.security')} className="dropdown-item">
                    <i className="ri-shield-keyhole-line text-muted fs-16 align-middle me-1"></i>
                ...
                {isSuperadmin ? (
                    <Dropdown.Item href={route('tenant.selector')} className="dropdown-item">
                        <i className="ri-building-line text-muted fs-16 align-middle me-1"></i>
                        <span className="align-middle">{t('My Tenants')}</span>
                    </Dropdown.Item>
                ) : (
                    <Dropdown.Item href={workspaceLink} className="dropdown-item">
                        <i className="ri-dashboard-line text-muted fs-16 align-middle me-1"></i>
