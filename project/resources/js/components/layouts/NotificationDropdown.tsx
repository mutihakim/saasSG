                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="ri-time-line"></i> Just 30 sec ago</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative active">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="ri-time-line"></i> 48 min ago</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="ri-time-line"></i> 2 hrs ago</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="ri-time-line"></i> 4 hrs ago</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="text-reset notification-item d-block dropdown-item" key={avatar + index}>
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-grow-1">
                                                ...
                                                <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i className="ri-time-line"></i> 30 min ago</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
