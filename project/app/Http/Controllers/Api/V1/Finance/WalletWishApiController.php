...
class WalletWishApiController extends Controller
{
    ...
    public function store(Request $request, Tenant $tenant): JsonResponse
    {
        ...
        $fresh = $wish->fresh(['ownerMember:id,full_name', 'approvedByMember:id,full_name', 'goal:id,name,wallet_id']);
    ...
    public function destroy(Request $request, Tenant $tenant, WalletWish $wish): JsonResponse
    {
        ...
        $before = $this->activityLogs->snapshot($wish->load(['ownerMember:id,full_name', 'approvedByMember:id,full_name', 'goal:id,name,wallet_id']));
        $beforeVersion = (int) $wish->row_version;
        $wish->delete();
    ...
    public function convert(Request $request, Tenant $tenant, WalletWish $wish): JsonResponse
    {
        ...
        $freshWish = $wish->fresh(['ownerMember:id,full_name', 'approvedByMember:id,full_name', 'goal:id,name,wallet_id']);
        $this->activityLogs->log(
            $request,
            $tenant,
