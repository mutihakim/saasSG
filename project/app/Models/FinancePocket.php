...
class FinancePocket extends Model
{
    ...
    {
        return $this->belongsToMany(TenantMember::class, 'finance_pocket_member_access', 'finance_pocket_id', 'member_id')
    ...
    {
        return $this->hasMany(FinanceTransaction::class, 'pocket_id');
    }

    public function savingsGoals(): HasMany
    {
        return $this->hasMany(FinanceSavingsGoal::class, 'pocket_id');
    }
}
